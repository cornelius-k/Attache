...
class SheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post sheets_url, params: { sheet: { template: @sheet.template, text: @sheet.text, text: @sheet.text, title: @sheet.title } }
    end
  ...
  test "should update sheet" do
    patch sheet_url(@sheet), params: { sheet: { template: @sheet.template, text: @sheet.text, text: @sheet.text, title: @sheet.title } }
