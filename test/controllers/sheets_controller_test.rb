...
class SheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post sheets_url, params: { sheet: { dossier_id: @sheet.dossier_id, template: @sheet.template, title: @sheet.title } }
    end
  ...
  test "should update sheet" do
    patch sheet_url(@sheet), params: { sheet: { dossier_id: @sheet.dossier_id, template: @sheet.template, title: @sheet.title } }
