...
class DossiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dossier" do
    assert_difference('Dossier.count') do
      post dossiers_url, params: { dossier: { template: @dossier.template, title: @dossier.title } }
    end
  ...
  test "should update dossier" do
    patch dossier_url(@dossier), params: { dossier: { template: @dossier.template, title: @dossier.title } }
