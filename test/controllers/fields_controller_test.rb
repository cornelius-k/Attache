...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { content: @field.content, section_id: @field.section_id } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { content: @field.content, section_id: @field.section_id } }
